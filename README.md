...
- 병역 : 미필/현역(병역특례를 목표로 준비중입니다.)   
- 사용 기술 : **Unity3D**, **WPF**, **DirectX**
...
- **참여 파트** :   
증명서 발급을 위한 단계 중 Unity/UGUI를 사용하여 매수 입력, 증명서 생성/신청   
단계의 UI및 기능 모듈 개발을 참여하였습니다. 또한 **프린트 출력 모듈** 제작   
업무(.NET 프린터 라이브러리)를 맡아서 진행하였습니다.
...
- **핵심기술** : Unity3D
- **참여 파트** :   
Unity/NGUI를 사용하여 2D 피팅모드 개발을 맡아서 참여하였습니다.   
2D 모드 UI 레이아웃/기능 개발 및 국가별 유니폼 피팅 상세정보   
(이미지 위치, 크기 등) **XML 데이터제작** 등의 업무를 수행하였습니다.
...
- **참여 파트** :   
외부 협력업체 에서 C++로 제작한 **시험결과 산출 DLL모듈**을 연동하여   
테스트 하는 작업을 주로 맡아서 개발하였습니다. DLL 모듈, 디자인 리소스   
제작을 제외한 모든 프로그래밍 개발 업무   
...
- **핵심기술** : WPF/.NET, Xml
- **참여 파트** :   
**WPF/MVVM** 패턴을 적용하여 시험결과로 산출된 XML 데이터를   
불러오는 기능을 제작하였습니다. UI 기능개발, 데이터 불러오기 등   
디자인 리소스를 제외한 모든 프로그래밍 개발 업무를 맡아서 진행하였습니다.
...
- **개발 인원** : 3명
- **참여 파트** :   
기획, 그래픽 리소스를 제외한 모든 프로그래밍 파트를 맡아서 개발한 게임입니다.   
DirectX를 사용하여 간단한 **프레임워크**를 제작하여 개발하였습니다.   
...
- **참여 파트** :   
기획, 그래픽 리소스를 제외한 모든 프로그래밍 파트를 맡아서 개발한 게임입니다.   
Unity/UGUI를 사용하여 개발하였으며, **JSON 파싱**을 이용하여 대화 스크립트 데이터  
를 로드하도록 개발하였습니다.

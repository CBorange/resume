...
- 사용 기술 : Unity3D, DirectX, WPF
- 병역 : 미필(병역특례 준비중입니다.)   

**게임개발자**를 목표로 공부하고 있습니다.   
프로그래머로써 폭넓게 알고 적용하기 위하여 **항상 탐구**하고 있습니다.
...
퍼즐/탈출 게임으로, 거울 반사 퍼즐을 해결하여 탈출하는 게임입니다.   
...
- 개발 인원 : 1인 개발
- 참여 파트 : 프로그래밍 전체
- 핵심 기술 : Socket Programing, 자체 통신 프로토콜 개발
